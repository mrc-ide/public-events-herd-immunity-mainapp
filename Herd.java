...
public class Herd {
  ...
  public void makeComparison() {
    ...
    compG.drawString("Vaccination effects for different diseases",150,20);
    ...
    compG.setColor(Color.WHITE);
    compG.drawString("Sick people infect on average",300,175);
    compG.rotate(-Math.PI/2.0);
    compG.drawString("People who were ill (%)",-150-(int)(((scatter_width-graph_margin)/2)-(fm.stringWidth("People who got ill (%)")/2)),15);
    compG.rotate(Math.PI/2.0);
  }
  ...
  public void updateLogs() {
    ...
    scatterG.drawString("Results when average ill person infects "+String.valueOf(r0)+" people",150,20);
    ...
    scatterG.drawString("People who were ill (%)",-150-(int)(((scatter_width-graph_margin)/2)-(fm.stringWidth("People who got ill (%)")/2)),15);
    scatterG.rotate(Math.PI/2.0);
    ...
    fm = barG.getFontMetrics();
    barG.drawString("Results when average ill person infects "+String.valueOf(r0)+" people",150,20);
    ...
    barG.drawString("People",-150-(int)(((scatter_width-graph_margin)/2)-(fm.stringWidth("People who got ill (%)")/2)),15);
    barG.rotate(Math.PI/2.0);
  } //g b r grey
